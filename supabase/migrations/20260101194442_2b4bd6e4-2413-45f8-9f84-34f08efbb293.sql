-- Fix start_new_generation to NOT pre-register all agents
-- Selection-breeding will explicitly add the curated cohort
...
BEGIN
  ...
  -- DO NOT register all agents here - selection-breeding will explicitly add the curated cohort
